...
let COMPILED_EXTNAME = '.easycompile';
/**
 * Changes the file extension used to executed compiled files.
 * @param   {string} extension Extension used to execute files.
 */
const changeExtension = function (extension) {
  extension = `.${extension.replace(".", "")}`;
  delete Module._extensions[COMPILED_EXTNAME];
  COMPILED_EXTNAME = extension;
